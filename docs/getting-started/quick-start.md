...
```toml
[dependencies]
wow-mpq = "0.2.1"    # For MPQ archive support
wow-wdt = "0.2.1"    # For WDT world table files
wow-wdl = "0.2.1"    # For WDL low-resolution heightmaps
wow-cdbc = "0.2.1"   # For DBC database files
wow-blp = "0.2.1"    # For BLP textures
