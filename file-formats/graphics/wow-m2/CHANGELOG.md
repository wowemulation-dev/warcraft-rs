...
- Created TBC model test suite with Blood Elf and Draenei support
...
- Added version-aware submesh parsing to handle vanilla (32-byte) vs post-vanilla (48-byte) submesh structures
